...
export const notificationPath = (item) => safeDoctorPath(item?.route, '/app/notifications');
...
export const getNotification = (id, signal) => request(`/care/notifications/${encodeURIComponent(id)}?app=${APP}`, { signal });

...
export function DecisionPanel({ proposal, options, isClaimed, claiming, claimError, decisionBusy, decisionError, onClaim, onRelease, onSubmit, decisionResult, verifiedDownstream, onFinishAndOpenNext }) {
  const safety = ['safety', 'emergency'].includes(proposal.status) || proposal.authority_route === 'physical_care';

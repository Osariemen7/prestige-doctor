...
const LandingPageNew = () => {
  ...
  // Add this function to handle opening the demo modal
  ...
  return (
    <>
      <Box sx={{ backgroundColor: '#050816', color: '#E0E0E0', overflowX: 'hidden' }}>
        ...
        <Section id="for-hospitals" sx={{ backgroundColor: '#0a192f', py: { xs: 8, md: 12 } }}>
          <Box textAlign="center" mb={10}>
            <Typography variant="h2" component="h2" sx={{ 
              ...
              Enterprise <span style={{ color: '#2C75FB' }}>Solutions</span>
            </Typography>
            <Typography variant="h5" component="p" sx={{ color: '#B0C4DE', maxWidth: '800px', mx: 'auto', lineHeight: 1.7, mb: 5 }}>
              Scale PrestigeHealth across your entire hospital system. Our enterprise solution offers customized implementation, dedicated support, advanced analytics, and seamless integration with your existing EMR systems. Improve provider efficiency and patient satisfaction at scale.
            </Typography>
            <Button
              variant="contained"
              size="large"
        ...
        <Dialog open={showDemoModal} onClose={() => setShowDemoModal(false)} maxWidth="md" fullWidth>
          <Box sx={{ position: 'relative', pt: '56.25%', height: 0 }}>
            <IconButton
              onClick={() => setShowDemoModal(false)}
              sx={{ position: 'absolute', top: 8, right: 8, zIndex: 2, color: 'white', background: 'rgba(44,117,251,0.7)' }}
            >
              <X />
            </IconButton>
            <iframe
              src="https://www.youtube.com/embed/dWsgfzqPN9E"
              title="Prestige Doctor Demo"
              frameBorder="0"
